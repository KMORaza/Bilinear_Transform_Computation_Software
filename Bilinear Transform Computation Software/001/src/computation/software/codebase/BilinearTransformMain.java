...
public class BilinearTransformMain extends JFrame {
    ...
    public BilinearTransformMain() {
        ...
        criticalFreqField.setEnabled(false); // Disabled by default
    ...
    private void computeTransform() {
        try {
            ...
            SymbolicTransferFunction discreteTf = bt.apply(preWarpedTf);
            ...
            output.append("Denominator: ").append(Arrays.toString(denCoeffs));
